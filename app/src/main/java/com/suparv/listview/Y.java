...
public class Y extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList1.add("1) Latin name : Yttrium");
        arrayList1.add("2) English name : Yttrium");
        arrayList1.add("3) Colour : Silver");
        arrayList1.add("4) Discovered by : Johan Gadolin ");
        arrayList1.add("5) Year discovered : 1794 ");
        arrayList1.add("6) Electron : 39");
        arrayList1.add("7) Proton : 39");
        ...
        arrayList2.add("1) Melting point : 1526.0 C = 1799.15 K");
        arrayList2.add("2) Boiling point : 3338 C = 3611.15 K");
        arrayList2.add("3) Phase at STP : Solid");
        arrayList2.add("4) Thermal conductivity : 17 W/(m K)");
        arrayList2.add("5) Thermal Expansion : 0.0000106 /K");
        arrayList2.add("6) Heat of Fusion : 11.4 kJ/mol");
        arrayList2.add("7) Heat of vapourisation : 380 kJ/mol");
        arrayList2.add("8) Young modulus : 64 GPa ");
        arrayList2.add("9) Sheer modulus : 26 GPa ");
        arrayList2.add("10 Bulk modulus : 41 GPa ");
        ...
        arrayList3.add("2) Atomic mass : 88.905 amu");
        arrayList3.add("3) Atomic radius : 178 pm");
        ...
        arrayList4.add("1) Electronegativity : 1.22 (Pauling Scale)");
        arrayList4.add("2) Electron Affinity : 29.6 kJ/mol");
        arrayList4.add("3) Ionistation Energy : 600 kJ/mol");
        ...
        arrayList5.add("3) CAS number : CAS7440-65-5");
        arrayList5.add("4) Refractive Index : NA");
        arrayList5.add("5) Speed of Sound : 3300 m/s");
        ...
        arrayList6.add("2) Debye temperature : 280 K");
        arrayList6.add("3) Lattice Constants : 364.74, 364.74, 573.06 pm");
        ...
        arrayList7.add("4) Neutron mass absorption : 0.00059");
        arrayList7.add("5) Neutron cross section : 1.28");
