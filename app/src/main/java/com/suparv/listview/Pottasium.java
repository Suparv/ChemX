...
public class Pottasium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pottasium);
        ...
        arrayList1.add("1) Latin name : Kalium");
        arrayList1.add("2) English name : Potassium");
        arrayList1.add("3) Colour : Silver");
        arrayList1.add("4) Discovered by : Humphry Davy");
        arrayList1.add("5) Year discovered : 1807 ");
        arrayList1.add("6) Electron : 19");
        arrayList1.add("7) Proton : 19");
